...
export type ContractContext = EthersContractContextV5<
  MuteSwitchRouterV2,
  MuteSwitchRouterV2MethodNames,
  MuteSwitchRouterV2EventsContext,
  MuteSwitchRouterV2Events
>;
...
export type MuteSwitchRouterV2Events = undefined;
export interface MuteSwitchRouterV2EventsContext {}
export type MuteSwitchRouterV2MethodNames =
  | 'WETH'
  | 'addLiquidity'
  | 'addLiquidityETH'
  | 'factory'
