...
export type ContractContext = EthersContractContextV5<
  MuteSwitchPairV2,
  MuteSwitchPairV2MethodNames,
  MuteSwitchPairV2EventsContext,
  MuteSwitchPairV2Events
>;
...
export type MuteSwitchPairV2Events = 'PairCreated';
export interface MuteSwitchPairV2EventsContext {
  PairCreated(...parameters: any): EventFilter;
}
export type MuteSwitchPairV2MethodNames =
  | 'new'
  | 'allPairs'
  | 'allPairsLength'
  | 'createPair'
