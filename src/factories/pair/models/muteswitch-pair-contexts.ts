...
export interface MuteSwitchPairContextForEthereumProvider
  extends MuteSwitchPairContextBase {
...
export interface MuteSwitchPairContextForProviderUrl
  extends MuteSwitchPairContextForChainId {
  providerUrl: string;
}
